...
'conf_del_event'    => 'Möchtest Du dieses Ereignis löschen?',
...
'click_here'        => '<a href="%s">Klicken Sie hier</a> fütere Informationen',
'contact_us'        => 'Please <a href="%s">contact us</a> for more information.',
'rem_subject'       => "Eine Ereigniserinnerung von {$_CONF['site_name']}",
'rem_msg1'          => "Du erhältst diese Erinnerung, weil Deine Adresse an {$_CONF['site_name']} gsendet wurde.",
...
'add_to_cats'       => 'Füge Dein Ereignis einer einzelnen oder mehreren Kategorien hinzu',
'cats_not_req'      => 'Das Hinzufügen Deines Ereignisses zu einer Kategorie, ist nicht notwendig.',
'cat_note1'         => 'Erstelle eine neue Kategorie für Dein Ereignis, an Stelle von oder zusätzlh zu einer existierenden Kategorie.',
'url'               => 'URL',
...
'country'           => 'Land',
'zip'               => 'Postleitzahl',
'for_more_info'     => 'Für mehr Informationen, kontaktiere',
'email'             => 'E-Mail',
'phone'             => 'Telefon #',
...
'select_range'      => 'Wähle einen Ereigniszeitraum zum Anzeigen',
...
'messages'          => array(
        ...
        9   => "Danke für das Einsenden Deines Ereignisses nach {$_CONF['site_name']}. Es wrde an unser Team übersendet und muss noch bestätigt werden. Wenn es bestätigt wurde,rd Dein Ereignis anderen zugänglich sein.",
        10  => 'Eingegebene Daten sind nicht gültig. Bitte überprüfe Deine Einsendung.',
        11  => 'Kategorien wurde aktualisiert.',
        12  => 'Erinnerung gespeichert. Du solltest eine E-Mail vor diesem Ererignis erhalten.',
        13  => 'Du hast eine ungültige oder falsch formatierte E-Mail Adressee angegeben. Btte versuche es erneut.',
        14  => 'Du muÃ angeben, wieviele Tage vor dem Ereignis Du erinnert werden möchtest',
...
$X_LANG_EVLIST01 = array (
    ...
    36  => 'Wähle einen Ereigniszeitraum zum Anzeigen',
    ...
    58  => 'Um Ereignisse zu verwalten, klicke auf "evList-Ereignisse" oben.<br />Um globale Optionen zu verwalten, klicke auf "evList-Konfiguration" oben.<br />Um Kategorienamen zu bearbeiten, oder Kategorien zu löschen oder zu aktivieren/deaktivieren, bearbeite oder markiere das entsprechende Kästchen unten. Du kannst auch neue Kategorien in den leeren Feldern der Tabelle unten erstellen.',
    59  => 'Um Ereignisse zu verwalten, klicke auf "evList-Ereignisse" oben.<br />Um Kategorien zu verwalten, klicke auf "evList-Kategorien" oben.<br />Um globale Optionen zu verwalten, bearbeite die Felder unten, wenn nötig.',
    ...
    65  => 'Das Deaktivieren einer Kategorie, deaktiviert <strong>nicht</strong> die Ereignisse in ihr.  Diese Ereignisse werden weiterhin in der Event-Liste erscheinen, wenn sie in eine andere Kategorie gehö oder wenn keine Kategorie gewät wurde.',
...
$X_LANG_EVLIST03 = array (
    ...
    2   => 'Ereignis ID# %s existiert nicht. Bitte überprüfe den Link und versuche es erneut.',
    3   => '<strong>Beginnt:</strong> ',
    4   => '<strong>Endet:</strong> ',
    5   => 'Bitte %s für mehr Informationen.',
    6   => 'kontaktiere %s',
    7   => 'kontaktiere uns',
    8   => 'Bearbeiten',
    9   => 'Schnelllöschen',
    ...
    20  => 'wöchentlich: %s',
    21  => 'und ',
    22  => 'und/oder wähle eine Kategorie',
    ...
    30  => "Du erhältst diese Erinnerung, weil Deine Adresse an {$_CONF['site_name']} gesendet wurde.",
    31  => 'Das Ereignis, %s, findet statt am oder um %s herum.',
    32  => 'Ereigniszusammenfassung: %s',
    33  => 'Für mehr Informationen besuche bitte %s',
    34  => "Danke von {$_CONF['site_name']}",
    35  => "jeden",
    36  => 'Möchtest Du dieses Ereignis löschen?',
    37  => 'All Day',
);
...
$X_LANG_EVLIST04 = array (
    ...
    37  => 'E-Mail',
    38  => 'Telefon #',
    39  => 'Für mehr Informationen, kontaktiere',
    40  => 'Land',
    ...
    69  => 'Neue Kategorie',
    70  => 'Erstelle eine neue Kategorie für Dein Ereignis, an Stelle von oder zusätzlich zu einer existierenden Kategorie.',
    71  => 'Füge Dein Ereignis einer einzelnen oder mehreren Kategorien hinzu',
    72  => 'Das Hinzufügen Deines Ereignisses zu einer Kategorie, ist nicht notwendig.',
...
$X_LANG_EVLIST07 = array (
    ...
    7   => 'evList-Standardeinstellungen wurden gesetzt.',
    8   => 'evList-Konfigurationseinstellungen wurden aktualisiert.',
    9   => "Danke für das Einsenden Deines Ereignisses nach {$_CONF['site_name']}. Es wurde an unser Team übersendet und muss noch bestätigt werden. Wenn es bestätigt wurde, wird Dein Ereignis anderen zugänglich sein.",
    10  => 'Eingegebene Daten sind nicht gültig. Bitte überprüfe Deine Einsendung.',
    11  => 'Kategorien wurde aktualisiert.',
    12  => 'Erinnerung gespeichert. Du solltest eine E-Mail vor diesem Ererignis erhalten.',
    13  => 'Du hast eine ungültige oder falsch formatierte E-Mail Adressee angegeben. Bitte versuche es erneut.',
    14  => 'Du mußt angeben, wieviele Tage vor dem Ereignis Du erinnert werden möchtest.',
...
$LANG_configselects['evlist'] = array(
    ...
    2 => array('Keine' => 0, 'Ereignis hinzufügen' => 1, 'Ereignisse auflisten' => 2),
